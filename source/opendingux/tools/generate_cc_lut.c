...
{
	size_t color;
	static const float display_gamma_inv = 1.0f / CC_TARGET_GAMMA;
	static const float rgb_max_inv       = 1.0f / CC_RGB_MAX;
	static const float adjusted_gamma    = CC_TARGET_GAMMA * CC_GAMMA_ADJ;
