...
#define COLOR_BACKGROUND       RGB888_TO_NATIVE(  0,  0,   48)
#define COLOR_ERROR_BACKGROUND RGB888_TO_NATIVE( 64,   0,   0)
#define COLOR_INACTIVE_TEXT    RGB888_TO_NATIVE( 64, 64,  160)
...
#define COLOR_TITLE_TEXT       RGB888_TO_NATIVE(128, 128, 255)
